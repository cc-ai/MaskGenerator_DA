...
from advent.utils.func import load_checkpoint_for_evaluation
...
def main():
    ...
    if cfg.TRAIN.checkpoint_iter != -1:
        i_iter = cfg.TRAIN.checkpoint_iter
        ...
        if not osp.exists(restore_from):
            ...
            if cfg.TEST.WAIT_MODEL:
                ...
                while not osp.exists(restore_from):
                    time.sleep(5)
        print("Continue to train model", restore_from)
